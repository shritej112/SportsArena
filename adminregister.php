...
if ($conn->connect_error) {
	...
	$INSERT = "INSERT into admin(username,password,email,address,contact,vkey)  values(?,?,?,?,?,?)";
//Prepare Statement
...
$mail->Body = "<a href='http://localhost/wwwf/adminverify.php?vkey=$vkey'>Register Account</a>";
