...
<a href="selectsport.php?var2=product1" >All </a>
</div>
</div>
<br>
</body>
...
$sql = "SELECT product_id, quantity,price,imagepath FROM $var2";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo'<a href="buytest.php?change='.$row["product_id"].'&ref='.$var2.'" target="_parent"><button >Buy </button></a>';
      echo'</div>';
      echo'</div>';
